...
var floorSchema = new Schema(
  {
    building_id: { type: Schema.Types.ObjectId, ref: "Building", required: true }, // Reference to the Building
    floor_number: { type: Number, required: true }, // Floor number (e.g., 1, 2, 3, etc.)
